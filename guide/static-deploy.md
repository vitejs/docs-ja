...
[Flightcontrol](https://www.flightcontrol.dev/?ref=docs-vite) を使用してデプロイする場合、この[指示](https://www.flightcontrol.dev/docs/reference/examples/vite?ref=docs-vite)に従います。
